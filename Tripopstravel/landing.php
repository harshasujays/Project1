...
<section class="featured-blogs">
    ...
    <div class="blog-grid">
        <div class="blog-card">
            <img src="blog/blog1.jpg" alt="Top Destinations in India">
            <div class="blog-content">
                <h4>Top 10 Destinations in India</h4>
                <p>Discover the most breathtaking places across India to plan your next adventure.</p>
                <a href="Mehida-Tripops/top 10.html" class="read-more">Read More</a>
            </div>
        </div>
        <div class="blog-card">
            <img src="blog/blog2.jpg" alt="Best Beaches">
            <div class="blog-content">
                <h4>16 Tips to Plan Your Trip</h4>
                <p>Discover 10 essential tips to plan your trip like a pro—covering everything from budgeting and packing to choosing destinations and creating the perfect itinerary.</p>
               <a href="Mehida-Tripops/how to travel for a trip.html" class="read-more">Read More</a>
            </div>
        </div>
        <div class="blog-card">
            <img src="blog/blog3.jpg" alt="Adventurous Trips">
            <div class="blog-content">
                <h4>Adventurous Trips for Thrill Seekers</h4>
                <p>Get your adrenaline pumping with these exciting adventure destinations.</p>
                <a href="Mehida-Tripops/world.html" class="read-more">Read More</a>
            </div>
        </div>
    </div>
</section>
